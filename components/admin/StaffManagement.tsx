    ...
    <View style={[styles.container, { backgroundColor: theme.bg }]}>
      ...
      <View style={styles.header}>
        <View>
          ...
          <Text style={[styles.subtitle, { color: theme.textSecondary }]}>
            Contrôle d'accès basé sur les rôles et permissions granulaires pour les collaborateurs ImmoCI.
          </Text>
        </View>
      ...
      <View style={styles.kpiRow}>
        <View style={[styles.kpiCard, { backgroundColor: theme.surface, borderColor: theme.border }]}>
          <Text style={[styles.kpiLabel, { color: theme.textSecondary }]}>TOTAL COLLABORATEURS</Text>
        ...
        <View style={[styles.kpiCard, { backgroundColor: theme.surface, borderColor: theme.border }]}>
          <Text style={[styles.kpiLabel, { color: theme.textSecondary }]}>GESTIONNAIRES IMMOBILIERS</Text>
        ...
        <View style={[styles.kpiCard, { backgroundColor: theme.surface, borderColor: theme.border }]}>
          <Text style={[styles.kpiLabel, { color: theme.textSecondary }]}>ADMINISTRATEURS</Text>
