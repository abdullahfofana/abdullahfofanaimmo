...
export default function ChatModal() {
  ...
  const handleSend = async () => {
    ...
    // Customer always sends as Client (You)
    await sendMessage(
        ...
        >
              ...
              <View style={[styles.supportCaseBanner, { backgroundColor: caseMeta.bg, borderColor: caseMeta.color + '30' }]}>
                <View style={styles.supportCaseLeft}>
                  ...
                  <Text style={[styles.caseBadgeText, { color: caseMeta.color }]}>
                    {loc(caseMeta.labelFr, caseMeta.labelEn)}
                  </Text>
                </View>
            ...
            <View style={styles.attachMenu}>
              <TouchableOpacity style={styles.attachOption} onPress={handleTakePhoto} activeOpacity={0.8}>
                ...
                <Text style={styles.attachOptionText}>
                  {loc('Prendre une photo', 'Take Photo')}
                </Text>
              </TouchableOpacity>
              ...
              <TouchableOpacity style={styles.attachOption} onPress={handlePickImage} activeOpacity={0.8}>
                ...
                <Text style={styles.attachOptionText}>
                  {loc('Galerie Photos', 'Photo Gallery')}
                </Text>
              </TouchableOpacity>
              ...
              <TouchableOpacity style={styles.attachOption} onPress={handlePickDocument} activeOpacity={0.8}>
                ...
                <Text style={styles.attachOptionText}>
                  {loc('Document (PDF / ACD / Reçu)', 'Document (PDF / Deed / Receipt)')}
                </Text>
              </TouchableOpacity>
            </View>
          )}

          {/* ── SENDER & RECIPIENT PARTICIPANT BAR ────────────────────── */}
          ...
          <View style={styles.inputBar}>
            ...
            <TextInput
              ...
              placeholder={loc('Écrivez votre message...', 'Type your message...')}
...
const styles = StyleSheet.create({
  ...
  clientSenderBadgeText: {
    fontSize: 10.5,
    fontWeight: '700',
    color: '#FFFFFF',
  },
  recipientIndicatorGroup: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 6,
  },
